  ...
  for (const row of results) {
    switch (row.type) {
        case 'DELIVERY':
            ...
            const itemExists = delivery.orderDetails.items.some(item => item.id === row.pedido_item_id);
        ...
        case 'ACTIVE_ORDER':
            activeOrders.push({
                ...
                client: { id: row.order_only_customer_id, name: row.order_only_client_name },
    ...
    return (
      <AppLayout title="Error">
        <div className="text-red-500 p-4 bg-red-50 rounded-lg border border-red-200">
            ...
            <p>No se pudieron cargar los datos de la página. Por favor, intente de nuevo más tarde.</p>
