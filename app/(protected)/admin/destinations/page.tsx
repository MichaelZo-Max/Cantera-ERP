  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        if (!destRes.ok) throw new Error(await destRes.text());
  ...
  if (loading) {
    return (
      <AppLayout title="Gestión de Destinos">
        <div className="p-6 text-center">Cargando destinos...</div>
      </AppLayout>
    );
  }
                ...
                >
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex space-x-2 pt-3 border-t">
                      ...
                      >
                        {destination.is_active ? <Trash2 className="h-3 w-3" /> : <CheckCircle className="h-3 w-3" />}
                        <span>
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingDestination ? "Actualiza los detalles del destino." : "Añade un nuevo destino para un cliente."}
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-6 pt-4">
              ...
              <DialogFooter className="pt-4">
                ...
                <Button type="submit" disabled={isSubmitting || !formData.clientId || !formData.nombre}>
                  <Save className="h-4 w-4 mr-2" />
                  {isSubmitting ? "Guardando..." : (editingDestination ? "Guardar Cambios" : "Crear Destino")}
                </Button>
              </DialogFooter>
            </form>
          </DialogContent>
