¡Por supuesto! He actualizado el `manual.MD` para reflejar con precisión los últimos cambios que implementamos, especialmente la autorización de múltiples camiones y choferes desde la creación del pedido.
